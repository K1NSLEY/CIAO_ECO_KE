...
def local_search_2opt(path, matrix):
    """
    Busca Local 2-opt.
    Tenta melhorar a rota realizando inversões de trechos do caminho.
    """
    improved = True
...
plt.grid()
plt.savefig("c:/Users/kinsb/Downloads/Nova pasta/CIAO_ECO_2026/AULA_07/lab01_convergencia.png")
print("[LAB 01] Gráfico salvo em lab01_convergencia.png")
